...
DDGWizard has two parts: A. Prediction part, for calculating ddG. B. Characterization part, for generating feature set to describe protein thermodynamics. Additionally, we provided a script to assist users with saturation mutagenesis and full-site saturation mutagenesis requirements in quickly preparing input files.   
